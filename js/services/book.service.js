...
function addGoogleBook(book) {
  ...
  var newBook = {
    ...
    listPrice: { amount: null, currencyCode: null, isOnSale: false },
...
function searchGoogleBook(keyword) {
  return axios
    .get(
      `https://www.googleapis.com/books/v1/volumes?printType=books&q=${keyword}`
    )
    .then(res => {
      return res;
    })
